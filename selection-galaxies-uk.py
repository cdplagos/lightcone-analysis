...
def prepare_data(phot_data, ids_sed, hdf5_data, hdf5_co_data, hdf5_data_groups, subvols, lightcone_dir,  nbands):
   ...
   #(29): "Band7_ALMA", "Band6_ALMA", "Band5_ALMA", "Band4_ALMA"
    ...
    writeon = True
    if(writeon == True):
       with open('/group/pawsey0119/clagos/Stingray/output/medi-SURFS/Shark-TreeFixed-ReincPSO-kappa0p002/deep-optical/Shark-deep-opticalLightcone-OpticalNIR.txt', 'wb') as fil:
            ...
            fil.write("#\n")
            fil.write("#dec ra redshift log10(mstar) log10(sfr) re B/T app_u app_g app_r app_i app_z app_VISTAY app_VISTAJ app_VISTAH app_VISTAK\n")
            for a,b,c,d,e,f,g,h,i,j,k,l,m,n,o,p in zip(dec[ind], ra[ind], zobs[ind], mstartot[ind], sfrtot[ind], re[ind], BT[ind], SEDs_dustin[2,:], SEDs_dustin[3,:], SEDs_dustin[4,:], SEDs_dustin[5,:], SEDs_dustin[6,:], SEDs_dustin[7,:], SEDs_dustin[8,:], SEDs_dustin[9,:], SEDs_dustin[10,:]):
                fil.write("%5.10f %5.10f %5.7f %5.2f %5.2f %5.2f %5.2f %5.2f %5.2f %5.2f %5.2f %5.2f %5.2f %5.2f %5.2f %5.2f\n" % (a,b,c,d,e,f,g,h,i,j,k,l,m,n,o,p))
